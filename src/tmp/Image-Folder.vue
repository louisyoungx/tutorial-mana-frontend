<template>
  <div class="flex flex-no-wrap bg-gray-200">
    ...
    <!-- Sidebar ends -->
    <div class="container mx-auto py-10 md:w-4/5 w-11/12 px-6 mt-4 sm:mt-0">
            ...
            >
              <div class="flex flex-col lg:mr-3 mb-4 lg:mb-0">
                ...
                <div class="relative">
                  ...
                  <input
                    id="search"
                    class="text-gray-600 focus:outline-none focus:border focus:border-blue-500 font-normal w-full sm:w-64 h-10 flex items-center pl-12 text-sm border-gray-300 rounded border"
              ...
              >
                ...
                <span class="ml-2">Add Folders</span>
              </button>
            </div>
          </div>
          <div class="mb-4 sm:hidden w-11/12 mx-auto relative rounded">
        ...
        >
          ...
          >
            <div class="rounded border-gray-400 border p-4">
              ...
              <p class="text-xs text-gray-800 font-bold">15 images</p>
            </div>
            <div class="rounded border-gray-400 border p-4">
              <div class="flex items-start justify-between mb-3">
                <img
