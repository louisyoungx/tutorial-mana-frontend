<template>
  <div class="flex flex-no-wrap">
    ...
    <!-- Sidebar ends -->
    <div class="w-full flex flex-wrap mt-8 lg:mt-0">
      <div class="xl:w-1/3 w-full border-r border-gray-300 flex-shrink-0">
        <div class="cursor-pointer p-6">
          <div class="flex items-center justify-between">
            <div class="relative">
              <div
                class="relative z-0 bg-gray-100 bg-white flex items-center justify-between rounded w-full cursor-pointer text-xs form-select block md:p-3 p-2 rounded bg-transparent"
                data-menu
              >
                <p
                ...
                >
                  Show:
                  <span class="text-indigo-700 mr-2">This week</span>
                </p>
              ...
              <ul
                class="invisible z-10 bg-white transition duration-300 opacity-0 bg-white shadow rounded mt-2 w-40 py-1 absolute"
              >
                <li
          ...
          <div class="flex flex-col">
            ...
            <div class="relative mt-6">
              ...
              <input
                id="email1"
                class="text-gray-600 focus:outline-none focus:border focus:border-blue-500 font-normal w-full h-10 flex items-center pl-12 text-sm border-gray-300 rounded border"
                placeholder="Search messages"
              />
            </div>
            <button
              class="bg-blue-500 flex justify-center items-center py-3 text-sm transition duration-150 ease-in-out hover:bg-blue-600 focus:bg-blue-600 focus:outline-none w-full text-white mt-6 rounded"
            >
              Compose Message
            </button>
          </div>
        </div>
        <div class="cursor-pointer p-6 border-r-4 border-orange-400">
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              ...
              <p class="text-gray-600 text-sm">Emily Rosenberg</p>
            </div>
            <p class="text-gray-600 text-sm">6:20 PM</p>
          </div>
          <h3 class="mt-2 text-xl text-gray-700">
            Urgent Meeting in Conference A
          </h3>
          <p class="text-sm text-gray-600 mt-3">
            Bibendum enim facilisis gravida neque convallis a. Consectetur
          ...
          <div class="mt-3 flex items-center justify-between">
            <div class="flex items-center text-gray-600">
              ...
              <p class="ml-2 text-sm">03 Attachments</p>
            </div>
            <div class="flex items-center text-gray-600">
              <div class="mr-3">
                <svg
        ...
        <div class="cursor-pointer p-6 bg-blue-100">
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <div class="h-12 w-12 mr-2">
                <img
        ...
        <div class="cursor-pointer p-6 border-r-4 border-red-400">
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <div class="h-12 w-12 mr-2">
                <img
        ...
        <div class="cursor-pointer p-6 mb-4">
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <div class="h-12 w-12 mr-2">
                <img
      ...
      <div class="xl:w-2/3 w-full pt-6 lg:pt-0">
        <div class="pt-6">
          <div class="px-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <div>
                  <p class="text-gray-700 text-lg">Emily Rosenberg</p>
                  <p class="text-gray-600 text-sm">
                    To: Me, Chandler, Rachel, Monica
                  </p>
                </div>
              </div>
              <p class="text-gray-600 text-sm">6:20 PM</p>
            ...
            <div class="flex items-center justify-between">
              <h3 class="mt-5 text-2xl text-gray-700">
                Urgent Meeting in Conference A
              </h3>
              <div class="flex items-center">
                <a
                  class="text-gray-600 mx-2 p-1 border-transparent border bg-gray-100 hover:bg-gray-200 cursor-pointer rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray"
                  href="javascript: void(0)"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  class="text-blue-500 mr-2 p-1 border-transparent border bg-gray-100 hover:bg-gray-200 cursor-pointer rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray"
                  href="javascript: void(0)"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  class="text-gray-600 mr-2 p-1 border-transparent border bg-gray-100 hover:bg-gray-200 cursor-pointer rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray"
                  href="javascript: void(0)"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="text-sm text-gray-600 mt-6">
              Sed ut dolore magnam aliquam quaerat voluptatem appetere eaque
              ipsa, quae ab illo inventore veritatis et harum quidem faciunt, ut
              summo bono, dolorem aspernari ut earum rerum necessitatibus saepe
              eveniet, ut de commodis suis cogitarent? at id ne ferae.
            </p>
            <p class="text-sm text-gray-600 mt-6">
              Probabo, inquit, sic agam, ut ratione voluptatem ut calere ignem,
              nivem esse albam, dulce mel quorum facta quem modo dixi,
              constituto, ut perspiciatis, unde omnis dolor sit, aspernatur aut
              contra sit, aspernatur aut dolores et rationibus conquisitis de
              commodis.
            </p>
            <hr
              class="border-b border-t-0 border-dashed border-gray-300 w-full my-6"
            />
            <h5 class="text-sm text-gray-800 mb-3">Attachments</h5>
            <div class="flex flex-col md:flex-row md:items-center">
              <div
                class="flex items-center p-3 mb-6 md:mb-0 md:mr-6 text-gray-600 border border-gray-300 rounded"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="ml-2 text-sm sm:text-xs lg:text-sm">
                  Cover Letter.pdf
                </p>
              </div>
              <div
                class="flex items-center p-3 mb-6 md:mb-0 md:mr-6 mr-6 text-gray-600 border border-gray-300 rounded"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-file"
              ...
              <div
                class="flex items-center p-3 text-gray-600 border border-gray-300 rounded"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-file"
          ...
          <hr class="border-b border-t-0 border-gray-300 w-full mt-6" />
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <div class="h-16 w-16 mr-2">
                ...
                <div>
                  <p class="text-gray-700 text-lg">Rachel Green</p>
                  <p class="text-gray-600 text-sm">To: Me, Chandler, Monica</p>
                </div>
              </div>
              <div class="flex items-center">
                <a
                  class="text-blue-500 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray"
                  href="javascript: void(0)"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="text-gray-600 text-sm ml-4">6:20 PM</p>
              </div>
            </div>
            <p class="text-sm text-gray-600 mt-2">
              Sed ut dolore magnam aliquam quaerat voluptatem appetere eaque
              ipsa, quae ab illo inventore veritatis et harum.
            </p>
          </div>
          <hr class="border-b border-t-0 border-gray-300 w-full" />
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <div class="h-16 w-16 mr-2">
                ...
                <div>
                  <p class="text-gray-700 text-lg">Chandler Bing</p>
                  <p class="text-gray-600 text-sm">To: Me, Rachel, Monica</p>
                </div>
              </div>
              <div class="flex items-center">
                <a
          ...
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <div>
                  <p class="text-gray-700 text-lg">Monica Geller</p>
                  <p class="text-gray-600 text-sm">To: Me, Chandler, Rachel</p>
                </div>
              </div>
              <div class="flex items-center">
                <a
          ...
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <div>
                  <p class="text-gray-700 text-lg">Joseph Tribbiani</p>
                  <p class="text-gray-600 text-sm">To: Me, Chandler, Rachel</p>
                </div>
              </div>
              <div class="flex items-center">
          ...
          <div class="p-6 bg-gray-100">
            <textarea
              class="resize-none focus:outline-none text-gray-700 w-full bg-transparent text-sm"
              value="Sed ut dolore magnam aliquam quaerat voluptatem appetere eaque ipsa, quae ab illo inventore veritatis et harum quidem faciunt, ut summo bono, dolorem aspernari ut earum rerum necessitatibus saepe eveniet, ut de commodis suis cogitarent? at id ne ferae."
            ></textarea>
            <div class="flex items-center justify-between">
              <div class="flex items-center">
              ...
              <button
                class="bg-blue-500 flex justify-center items-center py-3 px-6 text-sm transition duration-150 ease-in-out hover:bg-blue-600 focus:bg-blue-600 focus:outline-none text-white rounded"
              >
                Send Message
              </button>
            </div>
