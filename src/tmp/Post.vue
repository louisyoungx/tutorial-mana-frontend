<template>
  <div class="flex flex-no-wrap bg-gray-200">
    ...
    <!-- Sidebar ends -->
    <div class="container mx-auto py-10 md:w-8/12 lg:w-11/12 w-full px-6">
      <div
        class="w-full bg-white py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between px-5 sm:px-10 sm:shadow rounded"
      >
