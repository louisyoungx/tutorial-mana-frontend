<template>
  <div class="flex flex-no-wrap bg-gray-200">
    ...
    <div class="container mx-auto py-10 md:w-4/5 w-11/12 px-6">
      <div
        class="w-11/12 md:w-full bg-white py-5 sm:mb-4 px-5 px-10 sm:shadow rounded"
      >
        <h2 class="text-gray-700 text-2xl mb-4 sm:mb-0">Create Posts</h2>
      </div>
      <div
        class="container mx-auto grid items-start sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 md:mt-8 gap-8"
      >
        <div class="w-11/12 md:w-full rounded shadow bg-white">
          <div
            class="bg-gray-100 md:flex items-stretch w-full border border-gray-100"
          >
            <div
              class="bg-white text-gray-700 px-8 py-4 flex justify-center items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              class="cursor-pointer text-gray-700 px-8 py-4 flex justify-center items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              <p class="ml-2">Keywords</p>
            </div>
          </div>
          <div class="w-full px-8 py-6 border-b border-gray-300">
            <div class="flex flex-col xl:w-3/5 lg:w-2/6 w-full">
              <label for="title" class="pb-2 text-sm font-normal text-gray-800"
                >Post title</label
              >
              <input
                type="text"
            ...
            <div class="mt-6 flex flex-col w-full">
              <label
                for="content"
                class="pb-2 text-sm font-normal text-gray-800"
                >Text Content</label
              >
              <textarea
                id="content"
                name="content"
                class="border border-gray-300 pl-3 py-2 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 resize-none text-gray-800"
                placeholder="Iceland is one the most beautiful countires"
                rows="5"
                required=""
              ></textarea>
            </div>
          ...
          <div class="w-full px-8 py-6">
            <div class="flex flex-col xl:w-3/5 lg:w-2/6 w-full">
              ...
              <input
                ...
                name="caption"
                class="border border-gray-300 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 text-gray-800"
                placeholder="The beautiful landscapes"
                required=""
              />
            </div>
            <div class="mt-6 flex flex-col w-full">
              <label for="file" class="pb-2 text-sm font-normal text-gray-800"
                >Upload Images</label
              >
              <input
                type="file"
                id="file"
                name="file"
                class="hidden border border-gray-300 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 text-gray-800"
                placeholder="The beautiful landscapes"
                required=""
              />
              <div
                class="cursor-pointer w-full py-6 border border-blue-500 border-dashed rounded-lg flex justify-center items-center"
              >
              ...
              <div
                class="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6 gap-6"
              >
                <div class="trigger rounded h-24 relative">
                  <img
                    class="rounded absolute w-full h-full object-cover object-center"
                    src="../assets/images/images-8.png"
                  />
                  <div
                    class="controls rounded absolute inset-0 bg-black bg-opacity-75"
                  >
                    <div
                      class="cursor-pointer absolute top-0 right-0 mt-1 mr-1 text-white m-auto"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="icon icon-tabler icon-tabler-x"
        ...
        <div class="w-11/12 md:w-full rounded shadow bg-white p-8">
          <h5 class="mb-3 text-gray-700 text-left">Author</h5>
          <div class="relative">
            <select
              class="appearance-none cursor-pointer focus:outline-none w-full bg-gray-100 text-sm rounded px-4 py-3 text-gray-700"
            >
              <option value="1" back>
                <div class="flex items-center">
                  <div>
                    <img src="/cms-template/assets/images/Bitmap Copy 5.png" />
                  </div>
                  <div>Steve Lazardis</div>
                </div>
              </option>
              <option value="2">Ashley Wilson</option>
              <option value="3">Jackson Teller</option>
            </select>
            <div
              class="pointer-events-none absolute inset-0 m-auto mr-4 w-5 h-5 text-gray-600"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <h5 class="mt-6 mb-3 text-gray-700 text-left">Posting On</h5>
          <div class="relative">
            <div
              class="focus:outline-none w-full bg-gray-100 text-sm rounded px-4 py-3"
            >
              <p class="text-gray-700">21st August 2020</p>
            </div>
            <div
              class="pointer-events-none absolute inset-0 m-auto mr-4 w-5 h-5 text-gray-600"
            >
            ...
            <input
              type="date"
              class="opacity-0 w-12 m-auto absolute inset-0 mr-4 z-10"
            />
          </div>
          <h5 class="mt-6 mb-3 text-gray-700 text-left">Categories</h5>
          <div class="relative">
            <select
              class="appearance-none cursor-pointer focus:outline-none w-full bg-gray-100 text-sm rounded px-4 py-3 text-gray-700"
            >
          ...
          <h5 class="mt-6 mb-3 text-gray-700 text-left">Tags</h5>
          <div class="flex items-center">
            <div class="relative bg-gray-100 px-2 py-1 mr-3">
              <p class="text-sm text-gray-700">Rachel</p>
              <div
                class="border border-gray-200 cursor-pointer bg-white p-1 rounded-full absolute w-5 h-5 -mt-2 -mr-2 inset-0 m-auto flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-x"
            ...
            <div class="relative bg-gray-100 px-2 py-1 mr-3">
              <p class="text-sm text-gray-700">Harvey</p>
              <div
                class="border border-gray-200 cursor-pointer bg-white p-1 rounded-full absolute w-5 h-5 -mt-2 -mr-2 inset-0 m-auto flex items-center justify-center"
              >
                <svg
            ...
            <div class="relative bg-gray-100 px-2 py-1 mr-3">
              <p class="text-sm text-gray-700">Rosenberg</p>
              <div
                class="border border-gray-200 cursor-pointer bg-white p-1 rounded-full absolute w-5 h-5 -mt-2 -mr-2 inset-0 m-auto flex items-center justify-center"
              >
                <svg
          ...
          <div class="mt-8 flex flex-col sm:flex-row sm:items-center w-full">
            <button
              class="w-full sm:w-auto mb-4 sm:mb-0 sm:mr-4 py-2 px-3 rounded transition duration-150 ease-in-out flex items-center bg-blue-500 hover:bg-blue-600 focus:bg-blue-600 focus:outline-none text-sm text-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="icon icon-tabler icon-tabler-file-text"
              ...
              <span class="ml-2">Publish Post</span>
            </button>
            <button
              class="w-full sm:w-auto mb-4 sm:mb-0 sm:mr-4 py-2 px-3 rounded transition duration-150 ease-in-out flex items-center bg-gray-200 hover:bg-gray-300 focus:bg-gray-300 focus:outline-none text-sm text-blue-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span class="ml-2">Schedule Post</span>
            </button>
          </div>
        </div>
      </div>
